 ...
 * 
 *  @author Robert
 *  @see {@link starwars.entities.actors.actions.Attack}
 */

public class LightSaber extends SWEntity {
	private final int hitPoints = 999999999;
	/**
	 ...
	 * 
	 * @see {@link starwars.entities.actors.actions.Take}
	 * @see {@link starwars.Capability}
	 * @see {@link starwars.entities.actors.actions.Chop} 1
	 */
	public LightSaber(MessageRenderer m) {
		super(m);
		this.shortDescription = "A Lightsaber";
		this.longDescription = "A lightsaber.  Bzzz-whoosh!";
		this.hitpoints = hitPoints; // start with a nice powerful, sharp sword
