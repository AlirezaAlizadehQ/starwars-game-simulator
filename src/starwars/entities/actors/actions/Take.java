...
public class Take extends SWAffordance {
	...
	/**
	 * Perform the <code>Take</code> action by setting the item carried by the
	 * <code>SWActor</code> to the target (
	...
	public void act(SWActor a) {
		if (target instanceof SWEntityInterface) {
            ...
            // ad the throw affordance
            target.addAffordance(new Throw(theItem, messageRenderer));
		}
	}
