...
import starwars.entities.actors.actions.Move;
...
public abstract class SWActor extends Actor<SWActionInterface> implements SWEntityInterface {
	...
	public enum Force {MASTER, TRAINED, NOTTRAINED, NONE };
	private Force force;
	 ...
	 * @see 	#hitpoints
	 * @see 	#world
	 * @see 	starwars.entities.actors.actions.Attack
	 */
	...
	// constructor for SWActor. it sets its force levee too
    public SWActor(Force force, Team team, int hitpoints, MessageRenderer m, SWWorld world){
        this(team, hitpoints, m, world);
        this.setForce(force);
    }
    ...
    /**
     * Setter for the SWActor's force
     * @param force
     */
    ...
    /**
     * This methods returns the SWActor's force
     * @return actor.force
     */
