...
import starwars.entities.actors.actions.Sandcrawler;
...
public class SWWorld extends World {
	...
	public void initializeWorld(MessageRenderer iface) {
        ...
        int randX = random_1.nextInt(10);
        int randY = random_1.nextInt(10);

		BenKenobi ben = BenKenobi.getBenKenobi(iface, this, patrolmoves);
		ben.setSymbol("B");
		loc = myGrid.getLocationByCoordinates(randX,  randY);
		entityManager.setLocation(ben, loc);


		Random random_2 = new Random();
		randX = random_2.nextInt(10);
		randY = random_2.nextInt(10);
		// loc = myGrid.getLocationByCoordinates(randX,randY);
		loc = myGrid.getLocationByCoordinates(4,5);

		// Luke
		// changed hitpoints from 100 to 200
		...
		randX = random_3.nextInt(10);
        randY = random_3.nextInt(10);
        ...
        randX = random_4.nextInt(10);
        randY = random_4.nextInt(10);
		// A Tusken Raider
        ...
        randX = random_5.nextInt(10);
        randY = random_5.nextInt(10);
        // make a new instance of Droid
		SWDroid droid_1 = new SWDroid(Team.NEUTRAL,  "droid_1",
                20, iface, this);
        ...
        randX = random_6.nextInt(10);
        randY = random_6.nextInt(10);
        // make a new instance of Droid
        SWDroid droid_2 = new SWDroid(Team.NEUTRAL,  "droid_2",
                20, iface, this);
        droid_1.setSymbol("D2");
        loc = myGrid.getLocationByCoordinates(randX,randY );
        entityManager.setLocation(droid_2, loc);


        // make a new instance of Sandcrawler
        Sandcrawler sandcrawler = new Sandcrawler(patrolmoves, iface, this);
